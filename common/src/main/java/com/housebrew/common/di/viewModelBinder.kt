...
inline fun <reified ViewModelT : ViewModel> FragmentActivity.viewModelBinder(
    ...
    ViewModelProviders.of(this, object : ViewModelProvider.Factory {
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            val testViewModel = KodeinViewModelInjector.getTestViewModel(ViewModelT::class.java)
            @Suppress("UNCHECKED_CAST") return when (testViewModel) {
                null -> Kodein {
...
inline fun <reified ViewModelT : ViewModel> Fragment.viewModelBinder(
    baseContainer: Kodein = KodeinViewModelInjector.container,
    crossinline binder: (Kodein.Builder.() -> Unit)
) = lazy {
    ViewModelProviders.of(this, object : ViewModelProvider.Factory {
